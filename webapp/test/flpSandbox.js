		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zuiprdconsump-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuiprdconsump-display": {
								"semanticObject": "zuiprdconsump",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuiprdconsump",
									"url": sap.ui.require.toUrl("zuiprdconsump")
								}
							}
						}
					}
